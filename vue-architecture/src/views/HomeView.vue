              ...
              <ul>
                <li>
                  <a href="tel:+440 012 3654 896"
                    ...
                    ><span>+440 012 3654 896</span></a
                  >
                </li>
                <li>
                  <a href="mailto:support@colorlib.com"
                    ><span class="lnr lnr-envelope"></span
                    ><span>support@colorlib.com</span></a
                  >
                </li>
              </ul>
            </div>
          ...
          <div class="row small-gutters">
            <div class="col-lg-8 top-post-left">
              ...
              <div class="top-post-details">
                ...
                <ul class="meta">
                  <li>
                    <a href="#"><span class="lnr lnr-user"></span>Mark wiens</a>
                  </li>
                  <li>
                    <a href="#"
                      ><span class="lnr lnr-calendar-full"></span>03 April,
                      2018</a
                    >
                  </li>
                  <li>
              ...
              <div class="single-top-post">
                ...
                <div class="top-post-details">
                  ...
                  <ul class="meta">
                    <li>
                      <a href="#"
                        ><span class="lnr lnr-user"></span>Mark wiens</a
                      >
                    </li>
                    <li>
                      <a href="#"
              ...
              <div class="latest-post-wrap">
                ...
                <div class="single-latest-post row align-items-center">
                  <div class="col-lg-5 post-left">
                    <div class="feature-img relative">
                      <div class="overlay overlay-bg"></div>
                      <img class="img-fluid" src="@/assets/img/l2.jpg" alt="" />
                    </div>
                    <ul class="tags">
                ...
                <div class="single-latest-post row align-items-center">
                  <div class="col-lg-5 post-left">
                    <div class="feature-img relative">
                      <div class="overlay overlay-bg"></div>
                      <img class="img-fluid" src="@/assets/img/l3.jpg" alt="" />
                    </div>
                    <ul class="tags">
                ...
                <div class="single-latest-post row align-items-center">
                  <div class="col-lg-5 post-left">
                    <div class="feature-img relative">
                      <div class="overlay overlay-bg"></div>
                      <img class="img-fluid" src="@/assets/img/l4.jpg" alt="" />
                    </div>
                    <ul class="tags">
                  ...
                  <div class="col-lg-6 single-popular-post">
                    ...
                    <div class="details">
                      ...
                      <ul class="meta">
                        ...
                        <li>
                          <a href="#"
                            ><span class="lnr lnr-calendar-full"></span>03
                            April, 2018</a
                          >
                        </li>
                        <li>
                          <a href="#"
                            ><span class="lnr lnr-bubble"></span>06
                          </a>
                        </li>
                      </ul>
                      <p class="excert">
                  ...
                  <div class="single-list flex-row d-flex">
                    ...
                    <div class="details">
                      ...
                      <ul class="meta">
                        ...
                        <li>
                          <a href="#"><span class="lnr lnr-bubble"></span>06</a>
                        </li>
                      </ul>
                    </div>
                  </div>
